...
module.exports = {
	...
	BRANCH: 'master',
	STICKER_PACKNAME: process.env.STICKER_PACKNAME || 'false',
	...
	ANTILINK_MSG:
		process.env.ANTILINK_MSG || '「 *Antilink* 」\n\n➜ *&mention* kicked',
	ANTISPAM_MSG:
		process.env.ANTISPAM_MSG || '「 *Antispam* 」\n\n➜ *&mention* kicked',
	ANTIWORDS_MSG:
		process.env.ANTIWORDS_MSG || '「 *Badword* 」\n\n➜ *&mention* kicked_',
